...
if (isset($_SESSION['registration_success'])) {
    $success = true;
    unset($_SESSION['registration_success']); // Clear it after showing
}
...
function sendWelcomeEmail($email, $name) {
    ...
    try {
        ...
        $mail->AltBody = "Welcome, {$name}!\n\n" .
            ...
            "An email will be sent to notify you of the status of your account".
            ...
            <form id="signup-form" action="" method="POST">
                ...
                <?php if ($success): ?>
                    <div class="success-message">
                        Registration successful! Kindly wait for the admin to activate your account.
                    </div>
