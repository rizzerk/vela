...
// Check if notifications were clicked in this session
$notifications_clicked = $_SESSION['notifications_clicked'] ?? false;
...
try {
    if (isset($conn)) {
        ...
        // Count active announcements (hide if clicked in session)
