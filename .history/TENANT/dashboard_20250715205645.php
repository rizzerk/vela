...
.event-indicator.lease-start {
    background-color: #0369a1;
}
.event-indicator.lease-end {
...
.event-indicator.bill-overdue {
    background-color: #dc2626;
}
.bill-unpaid {
    background-color: #fef3c7;
}
.event-indicator.bill-unpaid {
    background-color: #d97706;
}
.bill-pending {
    background-color: #dbeafe;
}
.event-indicator.bill-pending {
    background-color: #1d4ed8;
}
.bill-rejected {
    background-color: #fecaca;
}
.event-indicator.bill-rejected {
    background-color: #b91c1c;
}
.bill-paid {
    background-color: #dcfce7;
}
.event-indicator.bill-paid {
