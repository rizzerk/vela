...
//tenant's lease details
$leaseQuery = "SELECT l.lease_id, l.start_date, l.end_date, l.monthly_rent, l.security_deposit, 
                      l.active, l.lease_terms, p.title AS property_name, p.address, p.description,
    ...
    <div class="main-container">
        <div class="lease-container">
            <?php if ($lease): ?>
                ...
                <div class="lease-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value amount"><?php echo formatCurrency($lease['monthly_rent']); ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Security Deposit</span>
                            <span class="info-value amount"><?php echo formatCurrency($lease['security_deposit']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="lease-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo htmlspecialchars($lease['landlord_name']); ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Email</span>
                            <span class="info-value"><?php echo htmlspecialchars($lease['landlord_email']); ?></span>
                        </div>
                        <div class="info-item">
                ...
                <!-- Lease Terms -->
                <?php if ($lease['lease_terms']): ?>
                <div class="lease-card">
                    <div class="card-header">
                        <i class="fas fa-file-alt"></i>
                        <h2 class="card-title">Lease Terms & Conditions</h2>
                    </div>
                    <div class="lease-terms">
                        <p><?php echo nl2br(htmlspecialchars($lease['lease_terms'])); ?></p>
                    </div>
                </div>
                <?php endif; ?>
