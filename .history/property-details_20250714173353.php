    ...
    <div class="container">
        ...
        <div class="application-section">
            ...
            <?php elseif ($_SESSION['role'] != 'general_user'): ?>
                <div class="login-prompt">
                    <p>Only registered accounts can apply for properties.<a href="registration.php" style="color: #7ab3ef; text-decoration: none;">Register here</a> to reserve property </p>
                </div>
            <?php else: ?>
