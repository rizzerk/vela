...
$project_root = $_SERVER['DOCUMENT_ROOT'] . '/vela/uploads/properties/'; // Adjust if your path is different
$upload_dir = $project_root . $property_id . '/';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!in_array($property_type, ['apartment', 'house', 'condo', 'studio', 'commercial', 'others'])) {
        $errors['status'] = "Invalid status selected";
    }
    ...
    if (empty($errors)) {
        ...
        $query = "INSERT INTO PROPERTY (title, address, status, property_type, description, monthly_rent) 
                  VALUES ('$title', '$address', '$status', '$property_type','$description', $monthly_rent)";
    ...
    <div class="form-container">
        ...
        <form action="add-property.php" method="POST" enctype="multipart/form-data" id="property-form">
            ...
            <div class="form-row">
                ...
                <div class="form-group <?php echo isset($errors['property_type']) ? 'has-error' : ''; ?>">
                    ...
                    <select id="property_type" name="property_type" class="form-control <?php echo isset($errors['property_type']) ? 'error' : ''; ?>" required>
                        ...
                        <option value="others" <?php echo ($_POST['property_type'] ?? '') === 'others' ? 'selected' : ''; ?>>Others</option>
                    </select>
                    <?php if (isset($errors['property_type'])): ?>
                        <div class="error-message">
                            <i class="fas fa-exclamation-circle"></i> <?php echo htmlspecialchars($errors['property_type']); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
