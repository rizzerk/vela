...
$monthly_maintenance = 0; // No cost field in maintenance_request table
        ...
        <div class="financial-card expenses-card">
            ...
            <div class="card-body">
                ...
                <div class="financial-metric total">
                    ...
                    <span class="metric-value">₱<?= number_format($monthly_utilities + $monthly_maintenance, 2) ?></span>
                </div>
            </div>
        </div>
        ...
        yearlyChart = new Chart(yearlyCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    label: 'Maintenance',
                    data: [15000, 10000, 12000, 18000, 8000, 5000, <?= $monthly_maintenance ?>, 0, 0, 0, 0, 0],
                        ...
                        callbacks: {
                            afterBody: function(context) {
                                ...
                                if (datasetIndex === 0) {
                                    ...
                                    const maintenance = context[2].raw;
                                    netIncome = rent - utilities - maintenance;
                                }
