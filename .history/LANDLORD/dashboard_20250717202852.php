...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'financial_data') {
    ...
    // Calculate totals - rent is income, utilities/penalties are income, other is expense
    $total_income = $rent_collected + $utilities + $penalties;
    $total_expenses = $other;
...
// Correct financial calculations - utilities/penalties are income, other is expense
$total_income = $yearly_collected + $yearly_utilities + $yearly_penalties;
$total_expenses = $yearly_other;
$net_profit = $total_income - $total_expenses;
