...
<body>
    <div class="mobile-navbar">
        ...
        <div class="mobile-dropdown" id="mobileDropdown">
            ...
            <a href="maintenance-req.php"><i class="fas fa-tools"></i> Maintenance Requests</a>
            <a href="#"><i class="fas fa-file-alt"></i> Tenant Applications</a>
            <a href="tenant-payments.php"><i class="fas fa-receipt"></i> Tenant Payments</a>
            <a href="tenant-payments.php"><i class="fas fa-history"></i> Tenant History</a>
            <a href="#"><i class="fas fa-user"></i> Landlord Profile</a>
        </div>
    </div>
