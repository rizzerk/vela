                ...
                <div class="financial-card expenses-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="financial-metric total">
                            ...
                            <span class="metric-value">₱<?= number_format($yearly_utilities + $yearly_penalties + $yearly_other, 2) ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="financial-card net-income-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="financial-metric total">
                            ...
                            <span class="metric-value">₱<?= number_format($yearly_collected - $total_expenses, 2) ?></span>
                        </div>
                    </div>
                </div>
            </div>
