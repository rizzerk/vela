...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'financial_data') {
    ...
    // Calculate expected rent based on filters
    $rent_multiplier = ($selected_month !== 'all') ? 1 : 12; // Monthly vs Yearly
    $expected_rent_query = "SELECT 
        COALESCE(SUM(p.monthly_rent * $rent_multiplier), 0) as total_rent,
    ...
    // yearly data for all bill types
