                    ...
                    <div class="announcement-card">
                        <div class="announcement-header">
                            ...
                            <div class="announcement-actions">
                                <button class="btn-edit" onclick="editAnnouncement(<?= $announcement['announcement_id'] ?>, <?= json_encode($announcement['title']) ?>, <?= json_encode($announcement['content']) ?>, '<?= $announcement['visible_to'] ?>', '<?= $announcement['priority'] ?>')">
