...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'financial_data') {
    ...
    $expected_rent_query = "SELECT 
        COALESCE(SUM(monthly_rent * 12), 0) as total_rent,
        COUNT(*) as property_count,
        SUM(CASE WHEN monthly_rent > 0 THEN 1 ELSE 0 END) as properties_with_rent
    FROM PROPERTY 
    ...
    // First get the debug data
$debug_data = $expected_rent_result->fetch_assoc();
...
error_log("Yearly Rent Debug: " . print_r($rent_debug, true));
